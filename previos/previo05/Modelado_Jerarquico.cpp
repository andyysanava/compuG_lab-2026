...
int main() {
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		modelTemp = model = glm::translate(model, glm::vec3(1.5f, 0.0f, 0.0f)); //coloca el pivote, en este caso lo manda en medio de la caja
    ...
    glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Model palma
		model = glm::translate(modelTemp,glm::vec3(1.0f, 0.0f, 0.0f)); //Regresamos a los valores anteriores de modelTemp 
